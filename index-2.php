    ...
    <div>
      <div  style="background:#660033" class="nine columns header_nav">
        <ul style="background:#660033" class="nav-bar horizontal">
		 ...
		 <li><a href="gal.php"><font color="#FFFFFF">galiray</font></a><a href="gal.php"class="flyout-toggle"></a></li>
...
<script src="../../zoyaaa/High Fashion Free Website Template - Free-CSS.com/high-fashion/javascripts/app.js"></script>
      ...
      <div class="three columns header_logo"> </div>
    </div>
    <!-- END Header -->
    <div class="show-for-large-up">
      <div class="row">
        <div class="twelve columns">
          <div id="featured"><img src="../picture/4.PNG" width="913"alt=""> <img src="../picture/Captured.PNG" width="913" alt=""> <img src="../picture/ww.PNG " width="913" alt=""></div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="twelve columns">
        <div class="heading_dots">
          <h1 class="heading_supersize"><span class="heading_center_bg"><font color="#660033">Welcome to Grocery shop!</font></span></h1>
        </div>
      </div>
    </div>
    <!-- end row -->
    ...
    <div class="row" style="padding-top: 20px">
      <div class="four columns"> <img src="../picture/download (4).jpg"g" alt="">
 
      </div>
      <div class="four columns"> <img src="../picture/download (5).jpg" alt="">
      
      </div>
      <div class="four columns"> <img src="../picture/download.jpg" alt="">
